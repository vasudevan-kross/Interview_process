...
import { createVideoCampaign, generateVideoQuestions } from '@/lib/api/video-interviews'
import { toast } from 'sonner'
import { Sparkles, Briefcase, Settings2, BrainCircuit } from 'lucide-react'

export default function NewVideoCampaignPage() {
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      router.push(`/dashboard/video-interviews/campaigns/${campaign.id}`)
    } catch {
  ...
  return (
    <div className="space-y-8 max-w-[1000px] mx-auto pb-12">
      <div className="flex items-center gap-4 border-b border-slate-200 pb-6">
        ...
        <div>
          <h1 className="text-2xl font-bold tracking-tight text-slate-900">New Video Campaign</h1>
          <p className="mt-1 text-sm text-slate-500">Configure your autonomous AI avatar-led interview flow.</p>
        </div>
      </div>
